    ...
    <div className="min-h-screen bg-gray-50 w-full overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          <Link
            to="/books/create"
            className="h-10 bg-blue-600 text-white px-4 rounded-md hover:bg-blue-700 flex gap-1 items-center justify-center font-semibold whitespace-nowrap"
          >
            <FontAwesomeIcon icon={faUserPlus} />
            <span>Add Book</span>
          </Link>

          <div className="h-10 flex items-center border border-gray-300 bg-white px-4 rounded w-full sm:w-72">
            <input
              type="text"
              placeholder="Search contact"
              value={search}
              ...
              className="flex-1 outline-none font-semibold min-w-0"
            />
      ...
      {/* TABLE */}
      <div className="bg-gray-100 rounded-lg shadow overflow-x-auto w-full">
        <table className="min-w-[800px] w-full text-md border border-gray-100">
          <thead className="bg-slate-100 text-gray-600 border-b border-gray-200">
            <tr>
              <th></th>
              <th className="px-6 py-3 text-start">ID</th>
